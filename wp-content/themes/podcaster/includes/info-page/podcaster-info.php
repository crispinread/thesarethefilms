							...
							switch ( $tab ){
								...
								case 'changelog' : 
									...
									<div class="feature-section">
										<ul id="changelog">
											<li class="first"><h2>1.6.1</h2> <span class="date">(28th December 2016)</span>
												<ul>
													<li><span class="label fix">Fix</span> New version (1.4) of Theme Station Podcasting Feed plugin added.
														<div class="file"><ul>
															<li><span class="root">functions/plugins/</span>thst-feed.php</li>
														</ul></div>
													</li>
													<li><span class="label improved">Improved</span> Microformats added selectively.
														<div class="file"><ul>
															<li><span class="root">post/</span>postfooter.php</li>
														</ul></div>
													</li>
													<li><span class="label improved">Improved</span> Updated screenshots.
														<div class="file"><ul>
